...
const accommodationOptions = {
  Mokopane: [
    { label: "Sinlge Room (En-suite) - R5500/Month", value: "Sinlge Room (En-suite) - R5500/Month" },
    { label: "Sharing Room (En-suite) - R3000/Month", value: "Sharing Room (En-suite) - R3000/Month" },
    { label: "Single Room - R3000/Month", value: "Single Room - R3000/Month" },
    { label: "Sharing Room - R2500/Month", value: "Sharing Room - R2500/Month" },
    { label: "Sharing Room (Voor Street) - R2000/Month", value: "Sharing Room (Voor Street) - R2000/Month" },
  ],
  Polokwane: [
    { label: "Sharing Room - R2500/Month", value: "Sharing Room - R2500/Month" },
  ],
                    ...
                    <FormControl>
                      ...
                      >
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal">Award: Introduction to the Hospitality Industry & Cooking - 06 Months</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem value="Certificate: Professional Cookery and the Principles of Hospitality - 10 Months" />
                          </FormControl>
                          <FormLabel className="font-normal">Certificate: Professional Cookery and the Principles of Hospitality - 10 Months</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem value="Diploma: Food Preparation and Culinary Arts - 10 Months" />
                          </FormControl>
                          <FormLabel className="font-normal">Diploma: Food Preparation and Culinary Arts - 10 Months</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem value="Pastry Diploma: Professional Patisserie - 10 Months" />
                          </FormControl>
                          <FormLabel className="font-normal">Pastry Diploma: Professional Patisserie - 10 Months</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem value="Mauritius Exchange Program Diploma: Advanced Food Preparation & Culinary Arts - 12 Months" />
                          </FormControl>
                          <FormLabel className="font-normal">Mauritius Exchange Program Diploma: Advanced Food Preparation & Culinary Arts - 12 Months</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem value="Occupational Grande Chef: Dual Qualification + Trade Test - 03 Years" />
                          </FormControl>
                          <FormLabel className="font-normal">Occupational Grande Chef: Dual Qualification + Trade Test - 03 Years</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem value="Online Award: Introduction to the Hospitality Industry & Cooking - 08 Months" />
                          </FormControl>
                          <FormLabel className="font-normal">Online Award: Introduction to the Hospitality Industry & Cooking - 08 Months</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem value="Online Certificate: Professional Cookery and the Principles of Hospitality - 12 Months" />
                          </FormControl>
                          <FormLabel className="font-normal">Online Certificate: Professional Cookery and the Principles of Hospitality - 12 Months</FormLabel>
                        </FormItem>
                      </RadioGroup>
                    </FormControl>
                    <FormMessage />
                    ...
                    <FormControl>
                      ...
                      >
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          ...
                          <FormLabel className="font-normal">Mokopane</FormLabel>
                        </FormItem>
                        <FormItem className="flex items-center space-x-3 space-y-0">
                          <FormControl>
                            <RadioGroupItem value="Polokwane" />
                          </FormControl>
                          <FormLabel className="font-normal">Polokwane</FormLabel>
                        </FormItem>
                      </RadioGroup>
                    </FormControl>
                    <FormMessage />
                  ...
                  <FormItem className="col-span-2">
                    <Checkbox
                      ...
                      onCheckedChange={(value) => {
                        field.onChange(value);
                        handleChange('needAccommodation', value);
                      }}
                    />
                    <FormLabel htmlFor="needAccommodation" className="ml-2">
                     Whould you like to apply for accommodation?
                    </FormLabel>
                  </FormItem>
                )}
              />
                    ...
                    <FormItem className="col-span-2">
                      ...
                      <FormControl>
                        <RadioGroup
                          onValueChange={(value) => {
                            field.onChange(value);
                            handleChange('accommodationOption', value);
                          }}
                          value={field.value}
                          className="flex flex-col space-y-1"
                        >
                          {accommodationOptions[selectedCampus].map((option) => (
